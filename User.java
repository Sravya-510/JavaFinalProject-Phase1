...
class Cam{ 
    ...
    private static void populateCameraList() { 
        cameraList.add(new Camera(1, "Canon", "EOS R", 500.0)); 
        cameraList.add(new Camera(2, "Nikon", "D850", 600.0)); 
        cameraList.add(new Camera(3, "Sony", "Alpha A7 III", 700.0));
        cameraList.add(new Camera(4, "Apple", "Camera1", 20000.0));
        cameraList.add(new Camera(5, "Samsung","Camera2", 700.0));
    } 
    ...
    private static void viewCamera() {
        if (currentUser != null) {
            System.out.println("Cameras you have rented:");
            boolean hasRentedCameras = false;
            ...
            for (Camera camera : cameraList) {
                if (camera.isRented()) {
                    ...
                    System.out.println("Rental Price per Day: $" + camera.getRentalPricePerDay());
                    System.out.println("Status: Rented");
                    hasRentedCameras = true;
                }
            }
            ...
            System.out.println("You need to be logged in to view your rented cameras.");
        }
    }
